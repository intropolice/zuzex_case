...
interface KitchenRoomViewProps {
  backgroundImage: string;
  title?: string;
}

export function KitchenRoomView({ backgroundImage, title = 'Кухня' }: KitchenRoomViewProps) {
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        >
          ...
          <div className="relative z-10 mt-12 rounded-2xl bg-black/45 border border-white/20 p-4 backdrop-blur-sm">
            <h1 className="text-center text-2xl font-bold text-white mb-3">{title}</h1>
