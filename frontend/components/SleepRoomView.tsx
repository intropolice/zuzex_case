...
interface SleepRoomViewProps {
  backgroundImage: string;
}

export function SleepRoomView({ backgroundImage }: SleepRoomViewProps) {
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 z-0 flex justify-center pointer-events-none">
            <LocationPetDisplay externalAnimationSrc="/sleep.mov" externalAnimationKey={sleepAnimationKey} />
          </div>
        </div>
      </div>
    </main>
